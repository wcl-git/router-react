!(function (a, b) {
  ...
  function k () {
    D.preVerifyState != 0 && (u || v || E.debug || z < '6.0.2' || D.systemType < 0 || A || (A = !0, D.appId = E.appId, D.initTime = C.initEndTime - C.initStartTime, D.preVerifyTime = C.preVerifyEndTime - C.preVerifyStartTime, H.getNetworkType({
      isInnerInvoke: !0,
      success: function (a) {
        var b, c
  ...
  if (!a.jWeixin) {
    return o = {
      ...
      for (b in o) a[o[b]] = b
      return a
    }()), q = a.document, r = q.title, s = navigator.userAgent.toLowerCase(), t = navigator.platform.toLowerCase(), u = !(!t.match('mac') && !t.match('win')), v = s.indexOf('wxdebugger') != -1, w = s.indexOf('micromessenger') != -1, x = s.indexOf('android') != -1, y = s.indexOf('iphone') != -1 || s.indexOf('ipad') != -1, z = (function () {
      ...
      ready: function (a) {
        G.state != 0 ? a() : (F._completes.push(a), !w && E.debug && a())
      },
      error: function (a) {
        z < '6.0.2' || B || (B = !0, G.state == -1 ? a(G.data) : F._fail = a)
      },
      ...
      uploadVoice: function (a) {
        c('uploadVoice', {
          localId: a.localId,
          isShowProgressTips: a.isShowProgressTips == 0 ? 0 : 1
        }, a)
      },
